...
import com.arceliktv.lotr.yto.common.log.LogHelper;
...
public abstract class BaseMailSender implements com.arceliktv.lotr.yto.common.mail.MailSender {
  ...
  @Override
  public com.arceliktv.lotr.yto.common.mail.MailSender createMail(String from, String to, String subject) throws MessagingException {
    return createMail(from, to, subject, null, null);
  }

  @Override
  public com.arceliktv.lotr.yto.common.mail.MailSender createMail(String from, String to, String subject, String cc)
      throws MessagingException {
    return createMail(from, to, subject, cc, null);
  }

  @Override
  public com.arceliktv.lotr.yto.common.mail.MailSender createMail(String from, String to, String subject, String cc, String bcc)
      throws MessagingException {
...
//    mimeMessage.addHeader("Content-Transfer-Encoding", "8bit");
  ...
  @Override
  public com.arceliktv.lotr.yto.common.mail.MailSender setMessage(String message) throws MessagingException {
  ...
  @Override
  public com.arceliktv.lotr.yto.common.mail.MailSender addAttachment(String path) throws MessagingException {
