package com.arceliktv.lotr.yto.common.helper;
...
public class SystemPropertyHelper {
  ...
  private static final String PROP_INTERNET_EXPLORER_DRIVER = "webdriver.ie.driver";
  ...
  public static String getJenkinsKey() {
